...
namespace XBoxControllerDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            //{
            //    Bat1Rectangle.Fill = new SolidColorBrush(e.Value >= BatteryLevel.Low ? Colors.Green : Colors.DarkGray);
            //    Bat2Rectangle.Fill = new SolidColorBrush(e.Value >= BatteryLevel.Medium ? Colors.Green : Colors.DarkGray);
            //    Bat3Rectangle.Fill = new SolidColorBrush(e.Value >= BatteryLevel.Full ? Colors.Green : Colors.DarkGray);
            //});
